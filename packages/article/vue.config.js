...
const port = process.env.MICRO_ARTICLE_PORT || VUE_APP_PORT || 8077;
const packageName = process.env.MICRO_ARTICLE_ROOT_DIR || 'article';

let publicPath = `//${process.env.MICRO_ARTICLE_HOST}:${port}${process.env.MICRO_PUBLIC_PATH}`;
